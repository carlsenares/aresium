...
const CATEGORIES: Cat[] = [
  ...
  { name: "Subscriptions", color: "#ef4444", icon: "📺", patterns: ["netflix", "spotify", "disney", "youtube premium", "amazon prime", "dazn", "audible", "icloud", "google one", "openai", "chatgpt", "anthropic", "github", "notion", "patreon", "twitch", "playstation", "nintendo", "xbox"] },
